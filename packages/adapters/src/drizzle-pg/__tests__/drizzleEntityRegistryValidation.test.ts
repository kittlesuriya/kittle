...
import { DrizzleEntityRegistry } from "kittle-adapters/drizzle-pg"

const table = pgTable("registry_rows", {
...
describe("PostgreSQL DrizzleEntityRegistry.register validation (P1-04)", () => {
